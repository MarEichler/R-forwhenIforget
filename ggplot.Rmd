...
Use `grid.draw` command from the `grid` package - as detailed [here on StackExchange](https://stackoverflow.com/questions/13294952/left-align-two-graph-edges-ggplot).  
```{r}
...
### Different geom types: bar chart & scatter plot  
